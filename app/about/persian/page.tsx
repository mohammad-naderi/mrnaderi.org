      ...
      <main className="philosophy-persian" lang="fa" dir="rtl">
        <section className="about-main shell">
          ...
          <div className="about-prose" style={{ textAlign: "right" }}>
            ...
            <p>
              من عضو گروه پژوهشی <span lang="en" dir="ltr">Common Space for Theoretical Practice (CSTP)</span> هستم و در <span lang="en" dir="ltr">Toronto Psychoanalytic Society &amp; Institute</span> فلسفهٔ معاصر فرانسه تدریس می‌کنم. کار کنونی‌ام از یک سو ادامهٔ بسط نظریهٔ سامان است و از سوی دیگر نگارش کتاب سومی که بداعت اساسی را به‌عنوان مقولهٔ مرکزی فلسفه مورد بررسی قرار می‌دهد.
            </p>
            <p>
